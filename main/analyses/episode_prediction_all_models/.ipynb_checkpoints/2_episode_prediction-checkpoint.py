...
print("Running mortality episode metrics")
...
for directory in directories:
    ...
    for model in directory[1]:
        ...
        for outcome in outcomes:
            ...
            table.to_csv(f"{directory[0]}/{model}/episode_prediction/{outcome}_episode_metrics.csv")
...
print("Running transition episode metrics")
...
for directory in directories:
    ...
    for model in directory[1]:
        ...
        for outcome in outcomes:
            ...
            table.to_csv(f"{directory[0]}/{model}/episode_prediction/{outcome[0]}_episode_metrics.csv")
