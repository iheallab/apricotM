...
if not os.path.exists(f"{MODEL_DIR}/apricotm"):
    os.makedirs(f"{MODEL_DIR}/apricotm")
...
with open(f"{MODEL_DIR}/apricotm/study_details.json", "w") as f:
...
with open("%s/apricotm/best_params.pkl" % MODEL_DIR, "wb") as f:
...
early_stopping = EarlyStopping(
    patience=2, verbose=True, path=f"{MODEL_DIR}/apricotm/model_weights.pth"
)
...
torch.save(model_architecture, f"{MODEL_DIR}/apricotm/model_architecture.pth")
