...
true_labels.to_csv(f"{MODEL_DIR}/apricott/results/prosp_true_labels.csv", index=None)
pred_labels.to_csv(f"{MODEL_DIR}/apricott/results/prosp_pred_labels.csv", index=None)