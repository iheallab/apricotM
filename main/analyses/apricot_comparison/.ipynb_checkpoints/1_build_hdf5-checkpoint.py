...
import numpy as np
import os
from variables import time_window, DATA_DIR, OUTPUT_DIR, ANALYSIS_DIR

if not os.path.exists(f"{ANALYSIS_DIR}/final_data"):
    os.makedirs(f"{ANALYSIS_DIR}/final_data")
...
with h5py.File("%s/final_data/dataset.h5" % ANALYSIS_DIR, "w", libver="latest") as hf:
