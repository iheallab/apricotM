...
if not os.path.exists(f"{MODEL_DIR}/apricotm/seq_len_weights"):
    os.makedirs(f"{MODEL_DIR}/apricotm/seq_len_weights")
...
for seq_len in seq_lengths:
    ...
    model_path = f"{MODEL_DIR}/apricotm/seq_len_weights/model_seq_len_{seq_len}.pth"
