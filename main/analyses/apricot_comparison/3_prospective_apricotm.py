...
for seq_len in seq_lengths:
    ...
    pred_labels.to_csv(f"{MODEL_DIR}/apricotm/seq_len_results/prosp_pred_labels_seq_len_{seq_len}.csv", index=None)
    true_labels.to_csv(f"{MODEL_DIR}/apricotm/seq_len_results/prosp_true_labels_seq_len_{seq_len}.csv", index=None)
