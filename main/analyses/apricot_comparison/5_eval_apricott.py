...
for seq_len in seq_lengths:
    ...
    for cohort in cohorts:
        ...
        pred_labels.to_csv(f"{MODEL_DIR}/apricott/seq_len_results/{cohort[1]}_pred_labels_seq_len_{seq_len}.csv", index=None)
        true_labels.to_csv(f"{MODEL_DIR}/apricott/seq_len_results/{cohort[1]}_true_labels_seq_len_{seq_len}.csv", index=None)