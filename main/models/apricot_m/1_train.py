...
if not os.path.exists(f"{OUTPUT_DIR}/model/apricotm"):
    os.makedirs(f"{OUTPUT_DIR}/model/apricotm")
...
with open("%s/model/apricotm/best_params.pkl" % OUTPUT_DIR, "wb") as f:
...
early_stopping = EarlyStopping(
    patience=3, verbose=True, path=f"{OUTPUT_DIR}/model/apricotm/apricotm_weights.pth"
)
...
torch.save(model_architecture, f"{OUTPUT_DIR}/model/apricotm/apricotm_architecture.pth")
