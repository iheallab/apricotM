...
# Write HTML string to a file (or you can store it in memory)
with open(f"{OUTPUT_DIR}/summary/patient_characteristics/patient_chacteristics.html", 'w') as f:
    f.write(all_chars.to_html())

# Generate a link to display the DataFrame
link = '<a href=f"{OUTPUT_DIR}/summary/patient_characteristics/patient_chacteristics.html" target="_blank">View DataFrame</a>'

print("Click the link below to view the DataFrame:")
print(link)
