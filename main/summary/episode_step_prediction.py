...
for outcome in outcomes:
    ...
    for cohort in cohorts:
        ...
        for task in tasks:
            ...
            sample_1 = table_comp.loc[(table_comp["cohort"] == cohort)&(table_comp["model"] == "sofa"), task].values[0]
    ...
    table_comp.to_csv(f"{OUTPUT_DIR}/summary/episode_prediction/{outcome}_threshold_comp.csv")
